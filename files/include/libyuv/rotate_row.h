...
void TransposeWx16_C(const uint8* src, int src_stride,
                     uint8* dst, int dst_stride, int width);
...
void TransposeWx8_Fast_DSPR2(const uint8* src, int src_stride,
                             uint8* dst, int dst_stride, int width);
void TransposeWx16_MSA(const uint8* src, int src_stride, uint8* dst,
...
void TransposeWx8_Any_DSPR2(const uint8* src, int src_stride,
                            uint8* dst, int dst_stride, int width);
void TransposeWx16_Any_MSA(const uint8* src, int src_stride,
                           uint8* dst, int dst_stride, int width);
...
void TransposeUVWx16_C(const uint8* src, int src_stride,
                       uint8* dst_a, int dst_stride_a,
                       uint8* dst_b, int dst_stride_b, int width);
...
void TransposeUVWx8_DSPR2(const uint8* src, int src_stride,
                          uint8* dst_a, int dst_stride_a,
                          uint8* dst_b, int dst_stride_b, int width);
void TransposeUVWx16_MSA(const uint8* src, int src_stride,
                         uint8* dst_a, int dst_stride_a,
                         uint8* dst_b, int dst_stride_b, int width);
...
void TransposeUVWx8_Any_DSPR2(const uint8* src, int src_stride,
                              uint8* dst_a, int dst_stride_a,
                              uint8* dst_b, int dst_stride_b, int width);
void TransposeUVWx16_Any_MSA(const uint8* src, int src_stride,
                             uint8* dst_a, int dst_stride_a,
                             uint8* dst_b, int dst_stride_b, int width);
