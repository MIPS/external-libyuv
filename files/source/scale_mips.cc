...
// This module is for GCC MIPS DSP
#if !defined(LIBYUV_DISABLE_MIPS) && defined(LIBYUV_DSP)
...
void ScaleRowDown2_DSPR2(const uint8* src_ptr, ptrdiff_t src_stride,
  ...
  "1:                                              \n"
    ...
    "lw             $t6, 24(%[src_ptr])            \n"  // |27|26|25|24|
    "lw             $t7, 28(%[src_ptr])            \n"  // |31|30|29|28|
    //  Use odd pixels instead of even.
...
void ScaleRowDown38_2_Int_DSPR2(const uint8* src_ptr, ptrdiff_t src_stride,
...
#endif  // defined(LIBYUV_DSP)

// This module is for GCC MIPS DSPR2
#if !defined(LIBYUV_DISABLE_MIPS) && defined(LIBYUV_DSPR2)

void ScaleRowDown34_0_Int_DSPR2(const uint8* src_ptr, ptrdiff_t src_stride,
...
void ScaleRowDown34_1_Int_DSPR2(const uint8* src_ptr, ptrdiff_t src_stride,
                                uint8* d, int dst_width) {
  __asm__ __volatile__ (
      ".set push                                           \n"
      ".set noreorder                                      \n"
